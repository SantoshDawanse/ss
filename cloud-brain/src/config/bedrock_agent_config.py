...
# Use Claude 3.5 Sonnet with inference profile (cross-region)
# Note: Inference profiles provide better availability and performance
BEDROCK_FOUNDATION_MODEL = "us.anthropic.claude-3-5-sonnet-20241022-v2:0"
