            ...
            <CardContent>
              <View className="mb-4">
                <View className="flex-row justify-between mb-2">
                  ...
                  <Text className="text-sm font-semibold text-neutral-900">0 / 0</Text>
                </View>
                <Progress value={0} showLabel variant="default" />
              </View>
              <View>
                <View className="flex-row justify-between mb-2">
                ...
                <Progress value={0} showLabel variant="success" />
              </View>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <View className="flex-row justify-between mb-3">
                <View className="flex-1 items-center p-4 bg-primary-50 rounded-xl mr-2">
                  ...
                  <Text className="text-2xl font-bold text-primary-700 mt-2">0</Text>
                ...
                <View className="flex-1 items-center p-4 bg-success-50 rounded-xl ml-2">
                  ...
                  <Text className="text-2xl font-bold text-success-700 mt-2">0</Text>
              ...
              <View className="flex-row justify-between">
                <View className="flex-1 items-center p-4 bg-secondary-50 rounded-xl mr-2">
                  ...
                  <Text className="text-2xl font-bold text-secondary-700 mt-2">0h</Text>
                ...
                <View className="flex-1 items-center p-4 bg-neutral-100 rounded-xl ml-2">
                  ...
                  <Text className="text-2xl font-bold text-neutral-700 mt-2">0</Text>
